...
class TurbineDisplay{
  ...
  public function __construct($row) {
    ...
    $this->turbineName = $row['turbineId'];
  ...
  public static function getTurbineBySiteId($siteId){
    ...
    // 2. Prepare the query
    $sql = 'SELECT td.turbineId as turbineId, t.turbineName as turbineName, t.turbineDescription as turbineDescription, td.siteId as siteId, t.capacity as capacity, t.rampUpTime as rampUpTime, t.maintenanceInterval as maintenanceInterval,
